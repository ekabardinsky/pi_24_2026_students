...
1. Отсутствие ключевых сущностей, которые явно требуются заданием (например, если задание
...
Критерии:
- Полное списывание (>90% сходства): одинаковая структура, те же классы, те же связи, те же названия методов — отличия лишь в пробелах или порядке строк.
